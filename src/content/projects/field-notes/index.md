---
title: Field Notes
logline: An ongoing collection of literary-nonfiction essays — on names, landscapes, machines, family, and the small daily failures of attention that turn out to be the only thing worth writing about.
...
Pieces that have cleared the line — published in outside venues or finished here — appear under <a href="/essays">Essays</a> tagged `field-notes`. Process notes about the revision and assembly of the collection itself live on this page, where they don't have to pretend to be finished.
